...
<!-- Keep this file in sync with .cursor/commands/new-invariant.md (identical content). -->
...
3. **For each invariant, work with the user to answer all five questions:**
   ...
   - **State it as a falsifiable property.** Name a specific function or data structure and a property that either holds or doesn't. "Pieces should be visible" fails this test. `"flipBoard(flipBoard(b))" deep-equals b` passes.
