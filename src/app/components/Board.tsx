...
export default function Board({ board, currentMove }: BoardProps) {
  ...
  return (
    <div style={{ display: "inline-block" }}>
      {/* Top file labels */}
      <div style={{ display: "flex", paddingLeft: "var(--sq-label)" as string }}>
        {FILES.map((f) => (
          <div
            key={f}
            style={{
              width: "var(--sq)" as string,
              textAlign: "center",
              fontSize: 12,
              color: "#8a7e6b",
          ...
          {row.map((piece, c) => {
            ...
            return (
              <div
                ...
                style={{
                  width: "var(--sq)" as string,
                  height: "var(--sq)" as string,
                  backgroundColor: baseColor,
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  position: "relative",
                  fontSize: "calc(var(--sq) * 0.625)" as string,
                  lineHeight: 1,
                  userSelect: "none",
                }}
              >
